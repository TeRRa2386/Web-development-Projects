...
app.post("/submit", (req, res) => {
  ...
  let adjPicked = adj[Math.floor((Math.random() * adj.length))]
  let nounPicked = noun[Math.floor((Math.random() * noun.length))]

  res.render('index.ejs', {adjective:adjPicked, noun:nounPicked});
});
